...
extension LabelProps {
  ...
  static func gameBoardLabelProps<K>(content: String, key: K, shouldPlay: Bool) -> LabelProps {
  ...
  static func loadingLabelProps<K>(key: K) -> LabelProps {
    var props = LabelProps()
    props.textAlignment = .center
    props.backgroundColor = .clear
...
extension ButtonProps {
  ...
  static func startButtonProps<K>(title: String, key: K, didTap: @escaping () -> ()) -> ButtonProps {
  ...
  /// - parameter key:    the key to associate with the element
  /// - parameter didTap: a closure that is invoked when the button is tapped
  static func loadSaveButtonProps<K>(title: String, key: K, didTap: @escaping () -> ()) -> ButtonProps {
    var props = ButtonProps()
  ...
  /// - parameter key:           the key to associate with the element
  static func gameCellButtonProps<K>(isWinningCell: Bool, didTap: (() -> ())?, key: K) -> ButtonProps {
    var props = ButtonProps()
